...
const EducationPage = () => {
    ...
    return (
        <div  className="w-full bg-white p-8 sm:min-h-card rounded-xl shadow-2xl outline outline-gray-300 outline-1">
        <h1 className="">Education</h1>
            ...
            <CustomImg src="https://github.com/minhdangphuoc/OpenGL-Renderer/raw/develop/screenshots/Animation.gif" alt="Assimp Animation Demo" description="Assimp Animation"/>
